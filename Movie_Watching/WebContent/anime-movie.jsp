            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        <a href="./anime-details-movie.jsp"><i class="fa fa-home"></i> Trở về</a>
                ...
                <div class="col-lg-12">
                    <div class="anime__video__player">
                        <video id="player" playsinline controls data-poster="./videos/anime-watch.jpg">
                            <source src="videos/yt1s.com - One Piece Film Red Đảo Hải Tặc  The Movie  Trailer Chính Thức_720p.mp4" type="video/mp4" />
